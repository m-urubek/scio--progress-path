 ...
 *
 * @param {HTMLElement} element - The container element with math expressions to render
 */
    ...
    mathElements.forEach(el => {
        ...
        if (latex && !el.hasAttribute('data-rendered')) {
            try {
                ...
                el.innerHTML = `<span class="katex-error" title="LaTeX error">${escapeHtml(latex)}</span>`;
            }
        }
    });
}
 ...
 *
 * @param {HTMLElement} element - The container element with code blocks to highlight
 */
 ...
 *
 * @param {HTMLElement} element - The container element to process
 */
 ...
 *
 * @param {string} elementId - The DOM element ID to process
 */
function renderRichContentById(elementId) {
...
window.renderingInterop = {
    ...
    renderRichContentById: renderRichContentById
};
